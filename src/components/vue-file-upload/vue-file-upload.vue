<template>
  <span class="vue-file-upload">
    <el-input
      ...
      :style="{'width': '70%'}"
    ></el-input>
    <el-button class="m-submit-btn upload-btn" size="small" type="primary" @click="clickBtn">浏览</el-button>
    <input ref="fileInput" id="fileInput" type="file" name="file" style="display: none">
  </span>
</template>
<script>
/*
...
export default{
      ...
      default: () => {
        return {
          formData: {
            ...
            totalAmount: 3.55,
            totalNum: 2,
            templateContent: '1_序号|2_账号|3_姓名|4_实发工资|'
          },
          headers: {},
          responseType: 'json',
  ...
  methods: {
    ...
    _onChange () {
      ...
      console.log(this.fileUploader.getAll())
