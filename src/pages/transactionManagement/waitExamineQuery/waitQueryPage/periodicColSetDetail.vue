    ...
    <div class="assets-debt">
        ...
        <div class="search-result">
          ...
          <div class="fs22" style="padding: 5px 15px;background: #fff;font-weight: 700">录入详情</div>
					<template>
            <el-tabs v-model="pActiveName">
						<el-tab-pane label="上存规则" name="first">
							<upload-rule v-if="propData && pActiveName === 'first'" :propData="propData"></upload-rule>
						</el-tab-pane>
						<el-tab-pane label="上存周期" name="second">
							<upload-cycle v-if="propData && pActiveName === 'second'" :propData="propData"></upload-cycle>
						</el-tab-pane>
						<el-tab-pane label="下拨规则" name="third">
							<dial-down-rule v-if="propData && pActiveName === 'third'" :propData="propData"></dial-down-rule>
						</el-tab-pane>
						<el-tab-pane label="下拨周期" name="fourth">
							<dial-down-cycle v-if="propData && pActiveName === 'fourth'" :propData="propData"></dial-down-cycle>
						</el-tab-pane>
					</el-tabs>
          </template>
					<m-new-form
...
import uploadRule from './periodicColSetDetail/uploadRule'
import uploadCycle from './periodicColSetDetail/uploadCycle'
import dialDownRule from './periodicColSetDetail/dialDownRule'
import dialDownCycle from './periodicColSetDetail/dialDownCycle'
