            ...
            <div class="contentWrap">
              <div class="content">
                ...
                <ul>
                  ...
                  <p>{{tableData._JnlData.ChargeAmount ? tableData._JnlData.ChargeAmount.data : 0 | amountFilter}}</p>
                </ul>
              </div>
              <div class="content leftLine">
                ...
                <ul>
                  <div class="itemWrap">
                    ...
                    <div class="item">
                      <div class="left">开户银行</div>
                      <div class="right leftLine overFont">{{tableData._JnlData.PayeeBankName ? tableData._JnlData.PayeeBankName.data : tableData._JnlData.清算银行 ? tableData._JnlData.清算银行.data : ''}}</div>
                    </div>
                  </div>
...
export default {
  ...
  created () {
    ...
    console.log(77777777777, this.tableData)
