  ...
  methods: {
    submit (data) {
      ...
      httpPost('/eweb-common.GenToken.do').then(token => {
        console.log(data)
        let singMsg = this.isSign({ _Data2Sign: data._Data2Sign, _authenticateType: data._authenticateTypeChoose })
        httpPost('/eweb-transfer.SHShipIncome.do', {
          _dataMapKey: data._dataMapKey,
          _authenticateTypeChoose: data._authenticateTypeChoose,
