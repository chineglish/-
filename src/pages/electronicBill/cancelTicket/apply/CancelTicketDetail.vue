  ...
  methods: {
    submit (data) {
      let params = {
        ...
        stdDrwrCod: data.stdDrwrCod, // 出票人组织机构代码
        stdDrwrAcc: data.stdDrwrAcc, // 出票人账户
        stdDrwrBnm: data.stdDrwrBnm, // 出票人行号
        stdAccpNam: data.stdAccpNam, // 承兑人名称
        stdPyeeNam: data.stdPyeeNam // 收票人名称
      }
      httpPost('eweb-edraft.VacatePcleConfirm.do', params).then(res => {
        this.$router.push({
