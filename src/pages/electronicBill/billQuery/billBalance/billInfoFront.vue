  ...
  <div>
    ...
    <div class="bottomWrap no-print">
        <div>
          ...
          <button class="el-button m-submit-btn" @click="backBillInfo">票据背面</button>
          <button class="el-button m-submit-btn" @click="transDetails">交易明细查询</button>
