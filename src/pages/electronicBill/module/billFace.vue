        ...
        <div class="t-header">
          <div class="t-header-lift">
            ...
            <div class="t-ticket-content">
              ...
              <div class="t-line-hight">&nbsp;{{tableData.stdDrwrBnm}}</div>
            </div>
          </div>
          <div class="t-header-right">
            ...
            <div class="t-ticket-content">
              ...
              <div class="t-line-hight">&nbsp;{{tableData.stdPyeeBnm}}</div>
            </div>
          </div>
        </div>
        <div class="t-money">
...
export default {
  ...
  methods: {
    ...
    backBillInfo () { // 票据背面
      const params = {
        acNo: this.$route.params.params.stdCustAcc,
        stdBillNum: this.tableData.stdBillNum,
        pageSize: 9999,
        pageIndex: 1
      }
      httpPost('/eweb-edraft.BillBackQry.do', params).then(resList => {
        this.$router.push({
          name: 'billBack',
          params: {
            ...
            pageNation: this.$route.params.pageNation, // 分页信息
            params: this.$route.params.params, // 查询条件
            name: this.$route.params.name // 路由
          }
        })
      }).catch(err => {
        console.error(err)
