<template>
  <div class="d2-panel-search-item" :class="hoverMode ? 'can-hover' : ''" flex>
    ...
    <div class="d2-panel-search-item__info" flex-box="1" flex="dir:top">
      <div class="d2-panel-search-item__info-title fs16" flex-box="1" flex="cross:center">
        <span>{{item.title}}</span>
      </div>
      <div class="d2-panel-search-item__info-fullTitle fs10" flex-box="0">
        <span>{{item.fullTitle}}</span>
      </div>
      <div class="d2-panel-search-item__info-path fs10" flex-box="0">
        <span>{{item.path}}</span>
      </div>
    </div>
  </div>
